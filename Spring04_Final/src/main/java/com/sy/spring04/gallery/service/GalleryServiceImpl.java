...
import com.sy.spring04.exception.NotDeleteException;
...
public class GalleryServiceImpl implements GalleryService {
		...
		//한 페이지에 몇개씩 표시할 것인지
	      ...
	      */
	      ...
	      if(!keyword.equals("")){
	         ...
	         if(condition.equals("caption_filename")){//제목 + 파일명 검색인 경우
	...
	@Override
	public void saveFile(GalleryDto dto, ModelAndView mView, HttpServletRequest request) {
